...
class PdfBack extends GetxController {
  final RxList<MatkulSchedule> _allMatkul = <MatkulSchedule>[].obs;
  List<MatkulSchedule> get allMatkul => _allMatkul;
  ...
  Future<void> uploadAndProcessPdf(selectedDay jadwalProvider) async {
      ...
      if (downloadResponse.statusCode == 200) {
        ...
        for (var courseData in jadwalList) {
          ...
          for (var jadwal in jadwalKuliah) {
            ...
            MatkulSchedule matkulObj = MatkulSchedule(
              day: hari,
              matkul: mataKuliah,
              startTime: jamAwal,
              endTime: jamAkhir,
        ...
        for (var matkul in _allMatkul) {
          ...
          jadwalProvider.jamAwal.value = matkul.startTime;
          jadwalProvider.jamAkhir.value = matkul.endTime ?? "";
